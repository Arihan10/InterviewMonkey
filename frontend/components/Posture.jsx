			...
			>
				<g id='posture'>
					<path
						...
						stroke={posture[0] ? "black" : "red"}
						stroke-width='15'
						className={
							"origin-bottom " + (posture[0] ? "" : "-rotate-12")
						}
					/>
					<rect
						id='shoulders'
						...
						width='202'
						height='15'
						fill={posture[1] ? "black" : "red"}
						className={
							"origin-center " + (posture[1] ? "" : "-rotate-12")
						}
					/>
				</g>
			</svg>
			<div className='text-red-500'>
				{!posture[0] && <TypographyP>Straighten Your Head</TypographyP>}
				{!posture[1] && (
