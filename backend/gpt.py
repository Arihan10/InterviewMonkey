...
class Gpt:
    ...
    def score(self, company, position, summary, question, response):
        ...
        Given an interview question and a candidates' response to it, you will grade the response based on its strength and the above criteria on a scale of 1-100. Your output will ONLY be a single integer, ranging from 1-100.
        """
